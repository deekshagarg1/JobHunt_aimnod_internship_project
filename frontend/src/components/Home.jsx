...
//     try {
//       const res = await axios.get(`http://localhost:5000/api/jobs?keyword=${query}`);
...
//   return (
//     <div className="home">
//       <div className="badge">No.1 Job Hunt Website</div>
//       <h1>Search, Apply &</h1>
...
//               <span className="job-time">1 Days ago</span>
